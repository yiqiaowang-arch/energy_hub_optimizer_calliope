...
path_first_part = os.path.join(
    r"C:\Users",
    os.getlogin(),
    r"OneDrive\ETHY3FW\semesterProjectYiqiaoWang\CEA\Altstetten\basecase_residential\outputs\data\optimization\calliope_energy_hub\global_emission_B162582",
)
